...
-- Design Ports Information
-- Saida	=>  Location: PIN_34,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Saida~0_combout\ = (\A~input_o\ & ((\C~input_o\ & (!\D~input_o\)) # (!\C~input_o\ & ((\B~input_o\)))))
